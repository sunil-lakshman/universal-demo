      ...
      return _regenerator2["default"].wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 4:
            ...
            return _context5.abrupt("return", new this.constructor(http, parseData(response, this.stackHeaders, this.content_type_uid, this.taxonomy_uid)));
          case 9:
    ...
    return _regenerator2["default"].wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 18:
          ...
          return _context6.abrupt("return", new this.constructor(http, parseData(response, this.stackHeaders, this.content_type_uid, this.taxonomy_uid)));
        case 23:
          throw (0, _contentstackError2["default"])(response);
        case 24:
          _context6.next = 29;
    ...
    return _regenerator2["default"].wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 6:
          ...
          return _context8.abrupt("return", new this.constructor(http, parseData(response, this.stackHeaders, this.content_type_uid, this.taxonomy_uid)));
        case 12:
          throw (0, _contentstackError2["default"])(response);
        case 13:
          _context8.next = 18;
...
function parseData(response, stackHeaders, contentTypeUID, taxonomy_uid) {
    ...
    return _regenerator2["default"].wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        ...
        case 10:
          ...
          return _context10.abrupt("return", new this.constructor(http, parseData(response, this.stackHeaders, this.content_type_uid, this.taxonomy_uid)));
        case 15:
          throw (0, _contentstackError2["default"])(response);
        case 16:
          _context10.next = 21;
