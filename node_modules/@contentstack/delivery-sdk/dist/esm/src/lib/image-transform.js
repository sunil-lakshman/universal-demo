...
import { CanvasBy, CropBy, } from './types';
export class ImageTransform {
     ...
     * const transformURL = url.transform(transformObj);
     */
    crop({ width, height, xval, yval, cropBy = CropBy.DEFAULT, safe = false, smart = false, }) {
        switch (cropBy) {
            case CropBy.DEFAULT: {
     ...
     * const transformURL = url.transform(transformObj);
     */
    canvas({ width, height, xval, yval, canvasBy = CanvasBy.DEFAULT, }) {
        switch (canvasBy) {
