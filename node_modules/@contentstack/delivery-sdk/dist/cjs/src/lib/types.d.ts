...
export declare enum CropBy {
    DEFAULT = "default",
    ASPECTRATIO = "aspectRatio",
    REGION = "region",
    OFFSET = "offset"
}
export declare enum FitBy {
    BOUNDS = "bounds",
    CROP = "crop"
}
...
export declare enum OverlayAlign {
    TOP = "top",
    BOTTOM = "bottom",
    LEFT = "left",
    RIGHT = "right",
...
export declare enum OverlayRepeat {
    X = "x",
    Y = "y",
    BOTH = "both"
}
export declare enum ResizeFilter {
    NEAREST = "nearest",
    BILINEAR = "bilinear",
    BICUBIC = "bicubic",
    LANCZOS2 = "lanczos2",
...
export declare enum TaxonomyQueryOperation {
    ABOVE = "$above",
    BELOW = "$below",
    EQ_ABOVE = "$eq_above",
    EQ_BELOW = "$eq_below"
