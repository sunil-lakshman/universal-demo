...
export declare interface IInitData {
    ...
    stackSdk: IStackSdk | any;
    editButton: IConfigEditButton;
}
export declare interface ILivePreviewMessageCommon {
    from: "live-preview";
}
export type ILivePreviewReceivePostMessages = IClientDataMessage | IInitAckMessage | IHistoryMessage | IDocWithScriptMessage;
...
export declare interface IDocWithScriptMessage extends ILivePreviewMessageCommon {
